...
h_file   = file('bsp-449STK2-temperature-scale.h', 'w')
inc_file = file('bsp-449STK2-temperature-scale.inc', 'w')

print >>inc_file, "/* Auto-generated by %s */\n" % sys.argv[0]
print >>h_file  , "/* Auto-generated by %s */\n" % sys.argv[0]

print >>inc_file, "#include \"bsp-449STK2-temperature-scale.h\""
